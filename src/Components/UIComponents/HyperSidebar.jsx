...
const HyperSidebar = () => {
  return (
    <div className="flex radar-dark-slate-bg">
    <div className="flex w-16 flex-col justify-between border-e">
      ...
      <div className="sticky inset-x-0 bottom-0 border-t border-gray-800 radar-dark-slate-bg p-2">
        <form action="#">
          <button
            type="submit"
    ...
    <div className="flex min-h-screen flex-1 flex-col justify-between radar-dark-slate-bg">
